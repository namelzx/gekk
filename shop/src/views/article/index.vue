<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="搜索标题" style="width: 200px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>
      <el-select v-model="listQuery.status" clearable class="filter-item" @change="handleFilter" placeholder="选择状态">
        <el-option
    ...
    >
      ...
      <el-table-column label="阅读量" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.view }}</span>
        </template>
      </el-table-column>

      <el-table-column label="文章排序" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.sort }}</span>
        </template>
      </el-table-column>

      <el-table-column label="文章状态" width="110px" align="center">
        <template slot-scope="scope">
...
<script>
  import {GetDataByList, GetIdByDel, PostDataBySave,PostDataByUp} from '@/api/article'
