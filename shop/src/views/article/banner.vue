<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="图标" width="150px" align="center">
        <template slot-scope="scope">
          <img :src="scope.row.images_url" width="70px" height="70px">
        </template>
      </el-table-column>
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px"
        ...
        <el-form-item label="是否启用">
          ...
          <el-select v-model="temp.status" class="filter-item" placeholder="Please select">
            <el-option v-for="(item,index) in StatusMap" :key="index" :label="item.name" :value="item.index" />
          </el-select>
        </el-form-item>
  ...
  <el-form-item label="图片" >
          <Upload :imageUrl="temp.images_url" @showParentComp="handelIco"/>
        </el-form-item>
...
<script>
  import {PostDataBySave, GetIdByDel, GetDataByList} from '@/api/banner'
