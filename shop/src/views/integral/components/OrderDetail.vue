  ...
  <div class="createPost-container">
    <div class="createPost-main-container">
          ...
          <div class="descriptionList">
            ...
            <div class="ant-row" v-else>
              <div class="ant-col-md-8">
                ...
                <div class="detail">{{postForm.intshop.name}}</div>
              </div>

              <div class="ant-col-md-8">
                <div class="term">取货码:</div>
                <div class="detail">{{postForm.claim_code}}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="ant-card" v-if="postForm.isadd==2">
        <div class="ant-card-body">
          <div class="descriptionList">
            <div class="title">核销商品</div>
            <div class="ant-row">
              <el-col :span="6">
                <el-input v-model="status" placeholder="输入取货码"></el-input>
              </el-col>
              <el-col :span="6">
                <el-button style="margin-left: 30px" type="primary" @click="onCourier">核销</el-button>
              </el-col>
            </div>
          </div>
        </div>
      ...
      <div class="goods-info" v-if="postForm.get_goods">
        <el-table :data="postForm.get_goods" border stripe style="width: 100%">
          ...
          <el-table-column prop="integral" align="center" label="所需积分"></el-table-column>
          <el-table-column prop="num" align="center" label="购买数量数量"></el-table-column>
        </el-table>
      </div>
    </div>
  </div>
...
import { GetIdByDetails, postCourier, postOrderClose } from "@/api/intOrder";
