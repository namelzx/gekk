   ...
   <el-row>
          ...
          <el-row :gutter="20">
            <el-col :span="7">
              <el-form-item label-width="100px" label="价格:">
                ...
                <el-col :span="7">
              <el-form-item label-width="100px" label="划线价格:">
        ...
        <div>
          <div>
            <el-card
              class="box-card"
              v-for="(sukitem,sukindx) in postForm.goods_suk"
              :key="sukindx"
            >
              <el-row :gutter="20">
                <el-col :span="7">
              ...
              <el-row :gutter="20">
                <el-col :span="7">
                  <el-form-item label-width="100px" label="SUK图片:" prod="category_id">
                    <SukImages
                      :imageUrl="sukitem.images_url"
                      :index="sukindx"
                      @showParentComp="HandelSukImages"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
        ...
        <div>
          <ListImage
            :list="banner"
            @showParentComp="HandelBanner"
            @RemoveParentComp="handleRemove"
          />
        </div>
        <divider title="商品介绍" />
